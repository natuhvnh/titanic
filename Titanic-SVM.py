...
# Read data
data = pd.read_excel(r"D:\NAL\Titanic\titanic3.xls")
...
C = 10 # svm regularization parameters
rbf_svm = svm.SVC(C= C, kernel= 'rbf', gamma= 0.01).fit(X_train, Y_train)
...
# SVM with linear kernel: 97.7%
# Linear SVM: 97.7%
# SVM with RBF (Radial basis function) kernel: 97.7%
# SVM with polynomial RBF: 96.9%
